...
#define $_INT(var, fallback)                                                (int var __unused = fallback; if(!(_callerArgs[@#var]==nil && _boundArgs[@#var]==nil) && ![(_callerArgs[@#var] ? _callerArgs[@#var] : _boundArgs[@#var]) isKindOfClass:[NSNumber class]]) [MLHandler throwDynamicUnpackingExceptionForType:@"!NSNumber(int)" andVar:@#var andUserData:(@{@"_boundArgs": _boundArgs, @"_callerArgs": _callerArgs}) andFile:(char*)__FILE__ andLine:__LINE__ andFunc:(char*)__func__]; if(!(_callerArgs[@#var]==nil && _boundArgs[@#var]==nil)) var __unused = _callerArgs[@#var] ? [_callerArgs[@#var] intValue] : [_boundArgs[@#var] intValue])
...
#define $_DOUBLE(var, fallback)                                             (double var __unused = fallback; if(!(_callerArgs[@#var]==nil && _boundArgs[@#var]==nil) && ![(_callerArgs[@#var] ? _callerArgs[@#var] : _boundArgs[@#var]) isKindOfClass:[NSNumber class]]) [MLHandler throwDynamicUnpackingExceptionForType:@"!NSNumber(double)" andVar:@#var andUserData:(@{@"_boundArgs": _boundArgs, @"_callerArgs": _callerArgs}) andFile:(char*)__FILE__ andLine:__LINE__ andFunc:(char*)__func__]; if(!(_callerArgs[@#var]==nil && _boundArgs[@#var]==nil)) var __unused = _callerArgs[@#var] ? [_callerArgs[@#var] doubleValue] : [_boundArgs[@#var] doubleValue]; } )
...
#define $_INTEGER(var, fallback)                                            (NSInteger var __unused = fallback; if(!(_callerArgs[@#var]==nil && _boundArgs[@#var]==nil) && ![(_callerArgs[@#var] ? _callerArgs[@#var] : _boundArgs[@#var]) isKindOfClass:[NSNumber class]]) [MLHandler throwDynamicUnpackingExceptionForType:@"!NSNumber(NSInteger)" andVar:@#var andUserData:(@{@"_boundArgs": _boundArgs, @"_callerArgs": _callerArgs}) andFile:(char*)__FILE__ andLine:__LINE__ andFunc:(char*)__func__]; if(!(_callerArgs[@#var]==nil && _boundArgs[@#var]==nil)) var __unused = _callerArgs[@#var] ? [_callerArgs[@#var] integerValue] : [_boundArgs[@#var] integerValue]; } )
...
#define $_UINTEGER(var, fallback)                                           (NSUInteger var __unused = fallback; if(!(_callerArgs[@#var]==nil && _boundArgs[@#var]==nil) && ![(_callerArgs[@#var] ? _callerArgs[@#var] : _boundArgs[@#var]) isKindOfClass:[NSNumber class]]) [MLHandler throwDynamicUnpackingExceptionForType:@"!NSNumber(NSUInteger)" andVar:@#var andUserData:(@{@"_boundArgs": _boundArgs, @"_callerArgs": _callerArgs}) andFile:(char*)__FILE__ andLine:__LINE__ andFunc:(char*)__func__]; if(!(_callerArgs[@#var]==nil && _boundArgs[@#var]==nil)) var __unused = _callerArgs[@#var] ? [_callerArgs[@#var] unsignedIntegerValue] : [_boundArgs[@#var] unsignedIntegerValue]; })
